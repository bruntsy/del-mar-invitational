...
export function normalizeGames(games: PartialGameConfig | null | undefined): GameConfig {
  return {
    ...
    highBallLowBall: {
      ...DEFAULT_GAMES.highBallLowBall,
      ...games?.highBallLowBall,
      stake: { ...DEFAULT_GAMES.highBallLowBall.stake, ...games?.highBallLowBall?.stake },
    },
    rotationSixes: { ...DEFAULT_GAMES.rotationSixes, ...games?.rotationSixes },
